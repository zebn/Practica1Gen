...
static void Main (string[] args)
{
        ...
        System.Console.WriteLine ("A new database called: Practica1GenNHibernate will be created (the previous information will be deleted).");
        System.Console.WriteLine ("-----------------------------------------------------------------------------");
        ...
        {
                if (ans.ToLower () == "y") {
                        CreateDB.Create ("Practica1GenNHibernate", "nhibernateUser", "nhibernatePass");
